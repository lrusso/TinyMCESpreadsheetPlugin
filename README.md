...
The plugin stores the cell formula as a class name in the cell tag and inserts the result as the cell value. Operators like + - * / % ( ) and cells references are allowed.
